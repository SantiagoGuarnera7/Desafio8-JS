...
// Definiciones de funciones
 ...
 function cargarProductos() { productos.push(new Producto(1, 'Pantalon', 2800, '../img/pantalonhombre.jpg'));
 productos.push(new Producto(2, 'Remera', 1500, '../img/remera negra.jpg'));
 productos.push(new Producto(3, 'Camisa', 2500, '../img/zapaMujer.jpg'));
 ...
 productos.push(new Producto(7, 'Vestido', 1900, '../img/vestidomuj.jpg'));
 productos.push(new Producto(8, 'Buzo Hombre', 1100, '../img/buzohomb.jpg'));
 productos.push(new Producto(9, 'Campera Nike', 1100, '../img/camperaNike.jpg'));
}
...
function guardarLocalStorage(elemento) {
    ...
    articulos.map(item => {
        ...
        this.guardarLocalStorage(elemento);
    })
